...
gulp.task('production', ['sass'], function() {
    livereload.listen();
    gulp.watch('src/FrontBundle/Resources/production/scss/**/*.scss', ['sass']).on('change', onChange);
    gulp.watch('src/FrontBundle/Resources/production/js/**/*.js', ['compress-js']).on('change', onChange);
});
